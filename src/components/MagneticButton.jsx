...
export const MagneticButton = ({
  ...
  useEffect(() => {
    ...
    const onMouseMove = (e) => {
      ...
      pendingX = (e.clientX - centerX) * 0.35;
      pendingY = (e.clientY - centerY) * 0.35;
      pendingGlowX = e.clientX - rect.left - rect.width / 2;
      pendingGlowY = e.clientY - rect.top - rect.height / 2;
