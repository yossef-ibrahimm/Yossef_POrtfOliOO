...
const AnimatedOrbs = memo(() => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/4 left-1/4 w-72 h-72 bg-primary/25 rounded-full blur-xl [will-change:transform]" />
      <div className="absolute bottom-1/4 right-1/4 w-64 h-64 bg-accent/25 rounded-full blur-xl [will-change:transform]" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-56 h-56 bg-purple-500/15 rounded-full blur-xl [will-change:transform]" />
      <div className="absolute top-1/3 right-1/3 w-32 h-32 bg-primary/15 rounded-full blur-lg [will-change:transform]" />
      <div className="absolute bottom-1/3 left-1/3 w-32 h-32 bg-accent/15 rounded-full blur-lg [will-change:transform]" />
    </div>
  )
})
