...
const socialLinks = [
  ...
  { icon: Linkedin, href: 'https://www.linkedin.com/in/youssef-ibrahim/', label: 'LinkedIn' },
]
...
export const Footer = () => {
  ...
  useEffect(() => {
    ...
    socialRefs.current.forEach((ref) => {
      ...
      const onDown = () => gsap.to(ref, { scale: 0.95, duration: 0.1 })
      const onUp = () => gsap.to(ref, { scale: 1.25, duration: 0.1 })
    ...
    return () => cleanupsRef.current.forEach((fn) => fn())
  }, [])
  ...
  return (
    <footer className="relative mt-20 border-t border-border/50 bg-gradient-to-b from-transparent via-primary/5 to-background overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute -top-40 -right-40 w-96 h-96 bg-primary/5 rounded-full blur-xl" />
        <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-accent/5 rounded-full blur-xl" />
      </div>
