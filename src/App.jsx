    ...
    >
      ...
      <motion.div
        style={{
          ...
          inset: '-50%',
          background: `
            radial-gradient(circle at 20% 30%, hsla(280, 100%, 50%, 0.15) 0%, transparent 40%),
            radial-gradient(circle at 80% 70%, hsla(200, 100%, 50%, 0.15) 0%, transparent 40%),
            radial-gradient(circle at 50% 50%, hsla(320, 100%, 50%, 0.1) 0%, transparent 50%)
          `,
        }}
        animate={{
          rotate: [0, 360],
      ...
      {[
        ...
        <motion.div
          ...
          style={{
            ...
            height: orb.size,
            borderRadius: '50%',
            background: `radial-gradient(circle, hsla(${orb.color}, 0.2) 0%, transparent 70%)`,
            filter: 'blur(40px)',
          }}
          animate={{
            scale: [1, 1.3, 1],
      ...
      <div
        style={{
          ...
          backgroundImage: theme === 'dark'
            ? `
              linear-gradient(hsla(280, 100%, 70%, 0.03) 1px, transparent 1px),
              linear-gradient(90deg, hsla(280, 100%, 70%, 0.03) 1px, transparent 1px)
            `
            : `
              linear-gradient(hsla(280, 100%, 20%, 0.03) 1px, transparent 1px),
              linear-gradient(90deg, hsla(280, 100%, 20%, 0.03) 1px, transparent 1px)
            `,
