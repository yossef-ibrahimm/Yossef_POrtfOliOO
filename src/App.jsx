...
===================================================== */
const MouseFollowers = memo(({ smoothX, smoothY, smoothX2, smoothY2, smoothX3, smoothY3 }) => (
  <>
    <motion.div
      style={{
        position: "fixed",
        ...
        height: 40,
        borderRadius: "50%",
        background: "radial-gradient(circle, hsla(280,100%,70%,0.8), transparent 70%)",
        transform: "translate(-50%,-50%)",
    ...
    <motion.div
      style={{
        ...
        height: 200,
        borderRadius: "50%",
        background: "radial-gradient(circle, hsla(320,100%,60%,0.15), transparent 70%)",
        transform: "translate(-50%,-50%)",
        willChange: "transform",
      }}
    />
